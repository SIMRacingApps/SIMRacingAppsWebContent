...
var SIMRacingAppsRequireConfig = {
    ...
    paths: {
        ...
        'angular-chart':    '/SIMRacingApps/external/angular-chart.1.1.1/angular-chart.min',
        'chart':            '/SIMRacingApps/external/chart.2.9.4/dist/Chart.min',
    ...
    shim: {
        ...
        'chart.js':         {'deps': ['chart'], 'exports': ['Chart'] },
