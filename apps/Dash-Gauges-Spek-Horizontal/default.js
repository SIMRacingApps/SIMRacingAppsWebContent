'use strict';
/**
 * This is the Spek Gauges App with horizontal layout to keep at the bottom of your screen.
 ...
 * 
 * <img src="../apps/Dash-Gauges-Spek-Horizontal/icon.png" />
 * 
 * @ngdoc apps
 * @name Dash-Gauges-Spek-Horizontal
...
function( angular,  SIMRacingApps) {
    angular.element(document).ready(function() {
        ...
        SIMRacingApps.start(angular.element(document.body),920,200,16);
