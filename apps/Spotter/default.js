'use strict';
/**
 * This is the Spotter, Broadcaster App.
...
function( angular,  SIMRacingApps) {
    angular.element(document).ready(function() {
        ...
        function($scope,  $timeout, sraDispatcher) {
           ...
           sraDispatcher.loadTranslations("/SIMRacingApps/apps/Spotter","text",function(path) {
           ...
           $scope.onClickCarSelector = function($clickedScope,name) {
               if ($scope.broadcaster) {
                   console.log("Spotter.setReferenceCar("+name+")");
