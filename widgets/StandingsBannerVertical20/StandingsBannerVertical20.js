'use strict';
/**
 * This widget displays a TV style banner showing the standings for 20 drivers.
 ...
 * Example:
 * <p><b>
 * &lt;sra-standings-banner-vertical20&gt;&lt;/sra-standings-banner-vertical20&gt;<br />
 * </b>
 * <img src="../widgets/StandingsBannerVertical20/icon.png" alt="Image goes here"/>
 * @ngdoc directive
 * @name sra-standings-banner-vertical20
...
define(['SIMRacingApps'
       ,'css!widgets/StandingsBannerVertical20/StandingsBannerVertical20'
       ,'widgets/LapsBanner/LapsBanner'
       ,'widgets/CarNumber/CarNumber'
],function(SIMRacingApps) {

    var self = {
        name:            "sraStandingsBannerVertical20",
        url:             'StandingsBannerVertical20',
        template:        'StandingsBannerVertical20.html',
        defaultWidth:    330,
        defaultHeight:   880,
...
//$scope.data.Session.Cars.Value = 20;                    
                    ...
                    if ((($scope.currentPage * $scope.numberOfGreenLines * $scope.numberOfGreenBoxes) + 1 + 10/*NumLeaders*/) > $scope.data.Session.Cars.Value
