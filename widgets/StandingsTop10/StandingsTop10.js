'use strict';
/**
 * This widget displays the official standings of the top 10 cars in a larger view so more data can be displayed than the Standings widget. 
 ...
 * Example:
 * <p><b>
 * &lt;sra-standings-top-10&gt;&lt;/sra-standings-top-10&gt;<br />
 * </b>
 * <img src="../widgets/StandingsTop10/icon.png" />
 * @ngdoc directive
 * @name sra-standings-top-10
 ...
 */
define(['SIMRacingApps','css!widgets/StandingsTop10/StandingsTop10','widgets/CarNumber/CarNumber'],
function(SIMRacingApps) {

    var self = {
        name:            'sraStandingsTop10',
        url:             'StandingsTop10',
        template:        'StandingsTop10.html',
        defaultWidth:    800,
        defaultHeight:   315,
    ...
    function(sraDispatcher) {
        return {
            ...
            controller: ['$scope', function($scope) {
                ...
                $scope.positions = ['P1','P2','P3','P4','P5','P6','P7','P8','P9','P10','REFERENCE'];
            ...
            , link: function($scope,$element,$attrs) {
                ...
                $scope.$watch("data.Car.REFERENCE.Position.Value", function(value) {
                    if (value)
                        $scope.positions[10] = (value > 10 ? 'REFERENCE' : 'P99');
                });
            }
        };
    }]);
