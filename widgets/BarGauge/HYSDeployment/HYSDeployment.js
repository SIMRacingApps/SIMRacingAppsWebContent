 ...
 * @ngdoc directive
 * @name sra-bar-gauge-h-y-s-deployment
 ...
 */
define(['SIMRacingApps','widgets/BarGauge/BarGauge','css!widgets/BarGauge/HYSDeployment/HYSDeployment'],
function(SIMRacingApps,BarGauge) {

    var self = {
        name:            "sraBarGaugeHYSDeployment",
        url:             'BarGauge/HYSDeployment',
