 ...
 * Example:
 * <p><b>
 * &lt;sra-text-gauge-h-y-s-charge&gt;&lt;/sra-text-gauge-h-y-s-charge&gt;
 * </b>
 * <img src="../widgets/TextGauge/HYSCharge/icon.png" />
 * @ngdoc directive
 * @name sra-text-gauge-h-y-s-charge
 ...
 */
define(['SIMRacingApps','widgets/TextGauge/TextGauge','css!widgets/TextGauge/HYSCharge/HYSCharge'],
function(SIMRacingApps,TextGauge) {

    var self = {
        name:            "sraTextGaugeHYSCharge",
        url:             'TextGauge/HYSCharge',
