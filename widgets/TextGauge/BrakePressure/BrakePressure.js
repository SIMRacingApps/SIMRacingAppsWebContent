 ...
 * Example:
 * <p><b>
 * &lt;sra-text-gauge-brake-pressure"&gt;&lt;/sra-text-gauge-brake-pressure&gt;
 * </b>
 * <img src="../widgets/TextGauge/BrakePressure/icon.png" />
 * @ngdoc directive
 * @name sra-text-gauge-brake-pressure
 ...
 */
define(['SIMRacingApps','widgets/TextGauge/TextGauge','css!widgets/TextGauge/BrakePressure/BrakePressure'],
function(SIMRacingApps,TextGauge) {

    var self = {
        name:            "sraTextGaugeBrakePressure",
        url:             'TextGauge/BrakePressure',
