 ...
 * <p>
 * <ul>
 *   <li>WARNING - something is wrong with your battery.</li>
 *   <li>CRITICAL - time to pit for repairs.</li>
 * </ul>
 * Example:
 * <p><b>
 * &lt;sra-text-gauge-voltage&gt;&lt;/sra-text-gauge-voltage&gt;
 * </b>
 * <img src="../widgets/TextGauge/Voltage/icon.png" />
 * @ngdoc directive
 * @name sra-text-gauge-voltage
 ...
 */
define(['SIMRacingApps','widgets/TextGauge/TextGauge','css!widgets/TextGauge/Voltage/Voltage'],
function(SIMRacingApps,TextGauge) {

    var self = {
        name:            "sraTextGaugeVoltage",
        url:             'TextGauge/Voltage',
        template:        'Voltage.html',
        defaultWidth:    380,
        defaultHeight:   120,
