'use strict';
/**
 * This widget displays the water temp.
 * <p>
 * States:
 * <p>
 * <ul>
 *   <li>WARNING - maybe some thing is wrong with the radiator or your drafting too much.</li>
 *   <li>CRITICAL - pit and repair your radiator or get some air to your engine.</li>
 * </ul>
 * Example:
 * <p><b>
 * &lt;sra-analog-gauge-spek-water-temp data-sra-args-show-digital-value="false"&gt;&lt;/sra-analog-gauge-spek-water-temp&gt;
 * </b>
 * <img src="../widgets/AnalogGauge/Spek/WaterTemp/icon.png" />
 * @ngdoc directive
 * @name sra-analog-gauge-spek-water-temp
 ...
 */
define(['SIMRacingApps','widgets/AnalogGauge/AnalogGauge','css!widgets/AnalogGauge/Spek/WaterTemp/WaterTemp'],
function(SIMRacingApps,AnalogGauge) {

    var self = {
        name:            "sraAnalogGaugeSpekWaterTemp",
        url:             'AnalogGauge/Spek/WaterTemp',
        template:        'WaterTemp.html',
        defaultWidth:    480,
        defaultHeight:   480,
