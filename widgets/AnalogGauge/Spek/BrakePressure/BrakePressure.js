'use strict';
/**
 * This widget displays the brake pressure.
 * <p>
 * Example:
 * <p><b>
 * &lt;sra-analog-gauge-spek-brake-pressure data-sra-args-show-digital-value="false"&gt;&lt;/sra-analog-gauge-spek-brake-pressure&gt;
 * </b>
 * <img src="../widgets/AnalogGauge/Spek/BrakePressure/icon.png" />
 * @ngdoc directive
 * @name sra-analog-gauge-spek-brake-pressure
 ...
 */
define(['SIMRacingApps','widgets/AnalogGauge/AnalogGauge','css!widgets/AnalogGauge/Spek/BrakePressure/BrakePressure'],
function(SIMRacingApps,AnalogGauge) {

    var self = {
        name:            "sraAnalogGaugeSpekBrakePressure",
        url:             'AnalogGauge/Spek/BrakePressure',
        template:        'BrakePressure.html',
        defaultWidth:    480,
        defaultHeight:   480,
