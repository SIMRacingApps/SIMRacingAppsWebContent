 ...
 * Example:
 * <p><b>
 * &lt;sra-analog-gauge-spek-h-y-s-charge data-sra-args-show-digital-value="false"&gt;&lt;/sra-analog-gauge-spek-h-y-s-charge&gt;
 * </b>
 * <img src="../widgets/AnalogGauge/Spek/HYSCharge/icon.png" />
 * @ngdoc directive
 * @name sra-analog-gauge-spek-h-y-s-charge
 ...
 */
define(['SIMRacingApps','widgets/AnalogGauge/AnalogGauge','css!widgets/AnalogGauge/Spek/HYSCharge/HYSCharge'],
function(SIMRacingApps,BarGauge) {

    var self = {
        name:            "sraAnalogGaugeSpekHYSCharge",
        url:             'AnalogGauge/Spek/HYSCharge',
