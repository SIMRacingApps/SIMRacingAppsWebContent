'use strict';
/**
 * This widget displays the official standings of the top 43 cars in a larger view so more data can be displayed than the Standings widget. 
 ...
 * Example:
 * <p><b>
 * &lt;sra-standings-top-43&gt;&lt;/sra-standings-top-43&gt;<br />
 * </b>
 * <img src="../widgets/StandingsTop43/icon.png" />
 * @ngdoc directive
 * @name sra-standings-top-43
 ...
 */
define(['SIMRacingApps','css!widgets/StandingsTop43/StandingsTop43','widgets/CarNumber/CarNumber'],
function(SIMRacingApps) {

    var self = {
        name:            'sraStandingsTop43',
        url:             'StandingsTop43',
        template:        'StandingsTop43.html',
        defaultWidth:    730,
        defaultHeight:   1045,
    ...
    function(sraDispatcher) {
        return {
            ...
            controller: ['$scope', function($scope) {
                ...
                $scope.positions = ['P1','P2','P3','P4','P5','P6','P7','P8','P9','P10','P11','P12','P13','P14','P15','P16','P17','P18','P19','P20','P21','P22','P23','P24','P25','P26','P27','P28','P29','P30','P31','P32','P33','P34','P35','P36','P37','P38','P39','P40','P41','P42','P43'];
                //load translations
            ...
            , link: function($scope,$element,$attrs) {
                ...
                $scope.$watch("data.Car.REFERENCE.Position.Value", function(value) {
                    if (value)
                        $scope.positions[42] = (value > 43 ? 'REFERENCE' : 'P43');
                });
